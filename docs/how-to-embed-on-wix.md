---
sidebar_position: 12
title: How to embed on Wix
---

# How to embed on Wix 🟧

ติดตั้ง **Rudi** ลงในเว็บไซต์ที่สร้างด้วย **Wix** ของคุณ เพื่อให้ลูกค้าทักคุยได้ทันที 💬
...
![Wix Dashboard](../static/img/Wix/website_dashboard.png)

- ไปที่เมนู Setting และเลือก Customize code

![Custom Code](../static/img/Wix/custom_code.png)

- คลิกที่ Add Custom Code

![Add Custom Code](../static/img/Wix/add_custom_code.png)
...
![Apply Embed](../static/img/Wix/create_embed.png)
