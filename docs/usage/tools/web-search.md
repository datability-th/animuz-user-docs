...
![Click plus button on Web Search tool](../../../static/v2/img/web-search-tool/1.1.1.png)

**1.1.2** คลิกที่ปุ่มเครื่องมือ **Web Search** ในหัวข้อ *Equipped tools*

![Click Web Search tool button](../../../static/v2/img/web-search-tool/1.1.2.png)
...
![Click Data Source icon](../../../static/v2/img/web-search-tool/1.2.1.png)

**1.2.2** คลิกที่ปุ่ม **Enable Web Search** เพื่อทำการเปิดใช้งานเครื่องมือ

![Enable Web Search](../../../static/v2/img/web-search-tool/1.2.2.png)
...
![Enter domain URL and click plus](../../../static/v2/img/web-search-tool/2.1.png)

**2.2** เลือก URL ที่ต้องการใช้ข้อมูล แล้วกดปุ่ม **Crawl Selected** จากนั้นรอระบบทำการ *Crawl URL* สักครู่

![Select URLs and click Crawl Selected](../../../static/v2/img/web-search-tool/2.2.png)

**2.3** ระบบทำการ *Crawl* เสร็จสิ้น ✅

![Crawl completed](../../../static/v2/img/web-search-tool/2.3.png)
...
![Data source display after adding URLs](../../../static/v2/img/web-search-tool/3.1.png)

**3.2** ดูข้อมูลภายในได้โดยทำการกดที่ลิงก์นั้น ๆ 🔗

![View data inside link](../../../static/v2/img/web-search-tool/3.2.png)
