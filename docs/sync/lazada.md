...
เชื่อมต่อร้านค้า **Lazada** ของคุณเข้ากับ **Rudi** เพื่อช่วยตอบลูกค้าและจัดการคำสั่งซื้อบนแพลตฟอร์ม Lazada 💬
...
![Sign In](../../static/img/Lazada/singIn.png)

2. เข้าสู่ระบบด้วยบัญชีผู้ขาย แล้วคลิก Buy it now (โดยไม่มีค่าใช้จ่าย ตามเงื่อนไขของแอป)

![Buy It Now](../../static/img/Lazada/buyItNow.png)

3. ยืนยันการซื้อบริการ

![Confirm Service](../../static/img/Lazada/confirmService.png)

4. ระบบจะแสดงหน้าจอยืนยันการซื้อสำเร็จ

![Service Success](../../static/img/Lazada/seviceSuccess.png)

5. สามารถตรวจสอบสถานะการซื้อได้ในระบบ

![Service Detail](../../static/img/Lazada/serviceDetail.png)
