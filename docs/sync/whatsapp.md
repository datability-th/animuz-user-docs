...
![Select WhatsApp Platform](../../static/img/WhatsApp/select_platform.png)

2. เลือก Assistant หรือหมาผู้ช่วย แล้วทำการกดปุ่ม **"Connect to WhatsApp"** 🐶

![Connect to WhatsApp](../../static/img/WhatsApp/connect_whatsapp.png)

3. ทำการเลือก Facebook Business ที่ต้องการให้ OrcaSync เข้าถึง หรือเลือกตามภาพคือให้เข้าถึงทั้งหมด 🏢

![Select Facebook Business](../../static/img/WhatsApp/select_business.png)

4. ทำการเลือก WhatsApp Account ที่ต้องการให้ OrcaSync เข้าถึง หรือเลือกตามภาพคือให้เข้าถึงทั้งหมด ✅

![Select WhatsApp Account](../../static/img/WhatsApp/select_account.png)

5. กด **Save** 💾

![Save](../../static/img/WhatsApp/save.png)

6. กด **Got it** 👌

![Got it](../../static/img/WhatsApp/got_it.png)

7. กด **Login with Facebook** 🔐

![Login with Facebook](../../static/img/WhatsApp/login_facebook.png)

8. กด **Continue** ➡️

![Continue](../../static/img/WhatsApp/continue.png)

9. ทำการเลือก Facebook Business Portfolio หากไม่มีเลยก็เลือกตามภาพ = สร้างใหม่หมด 🆕

![Select Business Portfolio](../../static/img/WhatsApp/business_portfolio.png)

10. ใส่ข้อมูลที่จำเป็นสำหรับการสร้าง Facebook Business Portfolio 📝

![Fill Portfolio Info](../../static/img/WhatsApp/portfolio_info.png)
